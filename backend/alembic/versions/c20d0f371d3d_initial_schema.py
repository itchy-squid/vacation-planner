...
Revision ID: c20d0f371d3d
Revises: 
Create Date: 2026-09-05 21:01:08.232899
...
def upgrade() -> None:
    ...
    sa.Column('date_line', sa.String(length=100), nullable=False),
    ...
    sa.Column('status', sa.Enum('empty', 'pencilled', 'placed', 'contested', 'locked', name='blockstatus'), nullable=False),
